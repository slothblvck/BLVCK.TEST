...
import WinnerCardAuction from './WinnerCardAuction'

const ExpiredContainerAuction = ({
    nft,
    userInfo,
    submiting,
    downloadCSV,
    ...
    const drawWinners = async () => {
        ...
        if (nft) {
            ...
            await axios
                .post(
                    `${BACKEND_URL}/users/getAuctionWinner`,
                    {
                        _id: nft._id,
                    },
                    config
    ...
    const drawWinnersUser = async () => {
        ...
        await axios
            .post(
                `${BACKEND_URL}/auth/saveWinnerAuction`,
                {
                    _id: nft._id,
                    channelID:
...
export default ExpiredContainerAuction
